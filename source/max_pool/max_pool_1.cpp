...
// Layer Params
#define od MAX_POOL_1_OUTPUT_DIM
#define ox MAX_POOL_1_OUTPUT_X
#define oy MAX_POOL_1_OUTPUT_Y
#define ix MAX_POOL_1_INPUT_X
#define iy MAX_POOL_1_INPUT_Y

// #define MAX_POOL_DEBUG

//void max_pool_1(hls::stream<result_t>& input, 		// where to get inputs
...
// Will it get stuck on input.read()?? Maybe need to check if all inputs are passed in to bypass this?
