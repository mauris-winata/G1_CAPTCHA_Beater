...
############################################################
cd hls_proj
open_project BatchNorm2.prj
set_top batch_norm2
add_files ../batch_norm/batch_norm2.cpp
add_files ../util/fixed_point.cpp
#add_files ../../util/shared.cpp
#add_files -tb ../batch_norm_test.h
#add_files -tb batch_norm_test2.cpp -cflags "-I. -std=c++0x"
...
#source "./BatchNorm2.prj/solution1/directives.tcl"
