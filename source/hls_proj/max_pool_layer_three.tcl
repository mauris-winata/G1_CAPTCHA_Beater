...
############################################################
cd hls_proj
open_project Max_Pool_3_Co_Sim
set_top max_pool_3
add_files ../util/fixed_point.cpp
add_files ../max_pool/max_pool_3.cpp
#add_files Fixed_Point/layers/max_pool/max_pool.cpp
#add_files ../../ProgramFiles2/Xilinx/Vivado/2018.3/include/hls_stream.h
#add_files Fixed_Point/layers/util/fixed_point.h
#add_files Fixed_Point/layers/util/data_structs.h
...
#source "./Max_Pool_3_Co_Sim/solution1/directives.tcl"
#csim_design
csynth_design
#cosim_design
