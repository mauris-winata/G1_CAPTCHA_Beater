...
// Layer Params
#define od MAX_POOL_3_OUTPUT_DIM
#define ox MAX_POOL_3_OUTPUT_X
#define oy MAX_POOL_3_OUTPUT_Y
#define ix MAX_POOL_3_INPUT_X
#define iy MAX_POOL_3_INPUT_Y
...
void max_pool_3(result_t input, 		// where to get inputs
				result_t* output)		// where to store outputs
{
	#pragma HLS INTERFACE axis depth=30000  port=input
	#pragma HLS INTERFACE axis depth=4256  port=output
