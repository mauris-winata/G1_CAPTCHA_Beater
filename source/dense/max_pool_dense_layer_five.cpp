...
void max_pool_dense_layer_five(
...
#pragma HLS resource variable=max_pool_dense_weights_five core=ROM_2P_BRAM latency=1
...
#pragma HLS pipeline II=1
						weights_biases_t weight = max_pool_dense_weights_five[(i_y*608 + i_x*32 + i_d)*57 + o_x];
		...
		{
#pragma HLS pipeline II=1
			bias = max_pool_dense_weights_five[242592 + o_b];
			out[o_b] += bias;
