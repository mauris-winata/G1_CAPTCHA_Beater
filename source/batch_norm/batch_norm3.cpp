...
#define b BATCH_NORM_3_BATCHES
#define id BATCH_NORM_3_INPUT_DIM
#define ix BATCH_NORM_3_INPUT_X
#define iy BATCH_NORM_3_INPUT_Y
...
//#pragma HLS PIPELINE II=8
			...
			gamma_t gamma = batchnorm_weights3[offset/sizeof(gamma_t) + b_*id*4 + i_d*4];
			beta_t beta = batchnorm_weights3[offset/sizeof(beta_t) + b_*id*4 + i_d*4 + 1];
			mean_t mean = batchnorm_weights3[offset/sizeof(mean_t) + b_*id*4 + i_d*4 + 2];
			var_t var = batchnorm_weights3[offset/sizeof(var_t) + b_*id*4 + i_d*4 + 3];
