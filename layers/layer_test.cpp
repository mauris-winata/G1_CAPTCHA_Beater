...
#include "dense/dense_layer_hls.h"
...
#include "dense_test/dense_test_hls.h"
#include "output/output_layer.h"
#include "dense/max_pool_dense_layer_hls.h"
#include "dense_test/max_pool_dense_test_hls.h"
...
int main(){
	...
	layer_params batch_norm_layer_3 = { .batch_size = BATCH_NORM_3_BATCHES,
                                           ...
                                           .kernel_size = -1, //unused
                                           .output_dim = BATCH_NORM_3_INPUT_DIM, //unused
                                           .output_height = BATCH_NORM_3_INPUT_Y, //unused
                                           .output_width = BATCH_NORM_3_INPUT_X, //unused
                                           .stride = -1 }; //unused
    ...
    layer_params max_pool_dense_layer_1 = { MAX_POOL_DENSE1_BATCHES,
                                            MAX_POOL_DENSE1_NUM_INPUTS,
                                            MAX_POOL_DENSE1_INPUT_Y,
                                            MAX_POOL_DENSE1_INPUT_X,
                                            MAX_POOL_DENSE1_NUM_OUTPUTS,
                                            MAX_POOL_DENSE1_OUTPUT_Y,
                                            MAX_POOL_DENSE1_OUTUPUT_X,
                                            -1,
                                            -1 }; //unused

    max_pool_dense_layer_test(MAX_POOL_DENSE_LAYER_1_TEST_INPUT_DATA, MAX_POOL_DENSE_LAYER_5_TEST_WEIGHTS_BIAS, MAX_POOL_DENSE_LAYER_1_TEST_GOLDEN_OUTPUT,
    ...
    #ifdef DENSE_1_LAYER
    layer_params dense_layer_1 = { DENSE2_BATCHES,
                                   MAX_POOL_DENSE1_NUM_OUTPUTS,
                                   DENSE2_INPUT_Y,
                                   DENSE2_INPUT_X,
                                   MAX_POOL_DENSE1_NUM_OUTPUTS,
    ...
    dense_layer_test(DENSE_LAYER_1_TEST_INPUT_DATA, DENSE_LAYER_5_TEST_WEIGHTS_BIAS, DENSE_LAYER_1_TEST_GOLDEN_OUTPUT,
