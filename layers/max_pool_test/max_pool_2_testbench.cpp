...
layer_params max_pool_parameters = {.batch_size = MAX_POOL_2_BATCHES,
									.input_dim = MAX_POOL_2_OUTPUT_DIM,
									.input_height = MAX_POOL_2_INPUT_Y,
									.input_width = MAX_POOL_2_INPUT_X,
									.output_dim = MAX_POOL_2_OUTPUT_DIM,
...
int main(){
	...
	// file handlers
	FILE* input_data_file = fopen(MAX_POOL_LAYER_2_TEST_INPUT_DATA, "r");
	FILE* golden_output_file = fopen(MAX_POOL_LAYER_2_TEST_GOLDEN_OUTPUT, "r");
	FILE* output_file = fopen(MAX_POOL_LAYER_2_TEST_OUTPUT_DATA, "w+");
	FILE* debug_output_file = fopen(MAX_POOL_LAYER_2_DEBUG_OUTPUT_DATA, "w+");
