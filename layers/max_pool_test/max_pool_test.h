...
#define MAX_POOL_LAYER_2_DEBUG_OUTPUT_DATA "debug_outputs/max_pool_2_debug.txt"
...
#define MAX_POOL_LAYER_3_DEBUG_OUTPUT_DATA "debug_outputs/max_pool_3_debug.txt"
