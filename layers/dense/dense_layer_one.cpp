...
#pragma HLS pipeline II=1
				...
				weights_biases_t weight = dense_weights_one[i_x * 19 + o_x];
...
#pragma HLS pipeline II=1
			...
			weights_biases_t weight = dense_weights_one[56 * 19 + o_x];
			weights_biases_t bias = dense_weights_one[1083 + o_x];
