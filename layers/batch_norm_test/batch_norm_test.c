...
void batch_norm_layer_test(const char* input_data,const char* weights, const char* golden_output_data, const char* output_data, int offset, const char* layer_name, layer_params_batch_norm batch_norm_parameters)
{
	// file handlers
	...
	// print_layer_test_result(layer_name, batch_norm_parameters, weights_size - batch_norm_parameters.output_dim, batch_norm_parameters.output_dim, batch_norm_error);
